...
# Added by Ben:
bgs = ['assets/Background.png', 'assets/Background2.png']
i = random.randint(0, len(bgs)-1)
back = bgs[i]
players = ['assets/new_player_2.0.png', 'assets/diver.png']
i = random.randint(0, len(players)-1)
p = players[i]
plastics = ['assets/plastic_bottel_new_vr2.0.png', 'assets/plastic bottle.png']
i = random.randint(0, len(plastics)-1)
pl = plastics[i]
...
pygame.time.set_timer(ADDPLASTIC, 2)
